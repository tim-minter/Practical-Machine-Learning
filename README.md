...
8. Click on the **Assets** tab and note the **file upload** section on the right had side (Click the **New data asset** link if the upload box doesn't appear). Add the data file discussed above to your project. ![Assets tab](https://github.com/tim-minter/machine-learning-with-streaming-data/blob/main/assetstab.png)
